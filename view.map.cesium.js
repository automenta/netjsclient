...
function renderCesiumMap(o, v) {
	...
	function updateMap() {
		...
		//addPrimitive(newCircle(40, -80, 200000, octagonVertexAngle, 1.0, 1.0, 1.0, 0.9, undefined /*'icon/climateviewer/caution.png'*/));
	...
	if (!cesiumLoaded) {
        ...
        LazyLoad.js("http://cesium.agi.com/Cesium/Build/Cesium/Cesium.js", init);
	}
	else {
		init();
	}
